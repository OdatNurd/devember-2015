...
(function (nurdz) {
    ...
    (function (game) {
        ...
        (function (SegmentType) {
             ...
             * (or some such).
             */
            SegmentType[SegmentType["VIRUS_ONE"] = -1] = "VIRUS_ONE";
            SegmentType[SegmentType["VIRUS_TWO"] = -2] = "VIRUS_TWO";
            SegmentType[SegmentType["VIRUS_THREE"] = -3] = "VIRUS_THREE";
            /**
        ...
        var GameScene = (function (_super) {
            ...
            function GameScene(name, stage) {
                ...
                for (var i = 0; i < BOTTLE_WIDTH * BOTTLE_HEIGHT; i++) {
                    ...
                    this._bottle[i] = {
                        type: game.Utils.randomIntInRange(0, SegmentType.SEGMENT_COUNT - 1),
                        color: colors[i % 3]
                    };
                }
            ...
            GameScene.prototype.drawVirusParts = function (x, y, points, color) {
             ...
             */
            GameScene.prototype.drawVirus = function (x, y, vParts, color) {
             ...
             */
            GameScene.prototype.drawSegment = function (x, y, type, color) {
                var startAngle;
                var endAngle;
                this._renderer.fillRect(x, y, game.TILE_SIZE, game.TILE_SIZE, '#aaaaaa');
                switch (type) {
                    ...
                    case SegmentType.SINGLE:
                        this._renderer.fillCircle(x + (game.TILE_SIZE / 2), y + (game.TILE_SIZE / 2), SEGMENT_SIZE / 2, color);
                        return;
                    ...
                    case SegmentType.TOP:
                        this._renderer.translateAndRotate(x + (game.TILE_SIZE / 2), y + (game.TILE_SIZE / 2), 270);
                        break;
                    case SegmentType.BOTTOM:
                        this._renderer.translateAndRotate(x + (game.TILE_SIZE / 2), y + (game.TILE_SIZE / 2), 90);
                        break;
                    case SegmentType.LEFT:
                        this._renderer.translateAndRotate(x + (game.TILE_SIZE / 2), y + (game.TILE_SIZE / 2), 180);
                        break;
                    case SegmentType.RIGHT:
                        this._renderer.translateAndRotate(x + (game.TILE_SIZE / 2), y + (game.TILE_SIZE / 2), 0);
                        break;
                }
                ...
                this._renderer.fillRect(-game.TILE_SIZE / 2, -SEGMENT_SIZE / 2, game.TILE_SIZE / 2, SEGMENT_SIZE, color);
            ...
            GameScene.prototype.render = function () {
                ...
                for (var x = 0; x < BOTTLE_WIDTH; x++) {
                    for (var y = 0; y < BOTTLE_HEIGHT; y++) {
                        ...
                        this.drawSegment(x * game.TILE_SIZE + this._bottleXPos, y * game.TILE_SIZE + this._bottleYPos, segment.type, segment.color);
                    }
                }
            };
            /**
